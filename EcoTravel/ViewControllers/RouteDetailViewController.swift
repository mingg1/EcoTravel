...
class RouteDetailViewController: UIViewController, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let origin = origin, let destination = destination, let destinationTitle = destinationTitle, let itinerary = itinerary {
            ...
            for leg in itinerary.legs {
                ...
                if (modeName != "WALK"){
                    ...
                    let itineraryStackView = generateStackView(axis: .horizontal, distribution: .equalCentering, alignment: .center, spacing:5)
                    ...
                    generateImageView(imgName: "circle.circle", superView: toStackView, mode: "", size: 32)
                    ...
                    let destinationStackView = generateStackView(axis: .horizontal, distribution: .equalCentering, alignment: .center, spacing: 5)
        ...
        scrollView.contentSize = CGSize(width: UIScreen.main.bounds.width, height: itineraryStackView.frame.height + 300)
    }
